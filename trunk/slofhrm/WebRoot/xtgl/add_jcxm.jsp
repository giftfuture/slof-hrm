...
<html>
    ...
    <script language=javascript>
        ...
        {alert("你必须选择监测项目类别!");document.form1.jcxmlb.focus();return;}
            ...
            document.form1.action="add_jcxm_tj.jsp";
...
%>
    ...
    <%@ include file="../isinrole.jsp"%>
		<table height="138" cellSpacing="0" cellPadding="0" width="100%" border="0">
			<TR>
				<TD class="heading" bgColor="#FFDAB9" height="20"><DIV style="font-size:15px;filter:progid:DXImageTransform.Microsoft.Glow(Color=#FFFFFF,Strength=3);width:200px"><font color="#4B0082">&nbsp;&nbsp;添加监测项目</DIV></TD>
			</TR>
			<TR>
				<TD vAlign="top" >
					<TABLE style="BORDER-COLLAPSE: collapse" height="101" cellSpacing="1" width="100%" bgColor="#666666" border="0">
						<TR>
							<TD bgColor="#FFFAFA" align="center">项目名称</TD>
							<TD bgColor="#ffffff">
								<table border="0" align="left" cellpadding="0" cellspacing="0">
									<TR>
										<TD>
											<font size=2><div id="div_jcxm" style="width:150px" name="div_jcxm" contenteditable onfocus="GetObjectName('jcxm')"></div></font>
											<input type="text" name="jcxm" id="jcxm" size="20" maxlength="50" style="display:none"/>
										</TD>
