...
<html>
    ...
    <script language=javascript>
        ...
        {alert("你必须选择报告类别!");document.form1.bglb.focus();return;}
            ...
            document.form1.action="add_jcxmtj_tj.jsp";
            document.form1.submit();}
        }

		function query(){
			document.form1.action="add_jcxmtj.jsp";
			document.form1.submit();
		}
...
<table height="138" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR>
		<TD class="heading" bgColor="#FFDAB9" height="20"><DIV style="font-size:15px;filter:progid:DXImageTransform.Microsoft.Glow(Color=#FFFFFF,Strength=3);width:200px"><font color="#4B0082">&nbsp;&nbsp;添加统计项目</DIV></TD>
	</TR>
	<TR>
		<TD vAlign="top" >
					...
					<TD bgColor="#ffffff">
						...
						if(!bglb.equals("")){
							...
							<TR>
								...
								<TD align="left">&nbsp;<input type=checkbox name="chkbx" id="chkbx" value="<%=jcxm_id%>"><%=jcxm_name%></TD>
							</TR>
							<%
							}
						}
