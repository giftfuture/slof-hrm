    ...
    <script language=javascript>
        function datacheck(){
			...
			{alert("你必须输入分子式!");document.all["div_fzs"].focus();return;}
				...
				document.form1.action="add_fzs_tj.jsp";
...
%>
    ...
    <%@ include file="../isinrole.jsp"%>
		<table height="138" cellSpacing="0" cellPadding="0" width="100%" border="0">
			<TR>
				<TD class="heading" bgColor="#FFDAB9" height="20"><DIV style="font-size:15px;filter:progid:DXImageTransform.Microsoft.Glow(Color=#FFFFFF,Strength=3);width:200px"><font color="#4B0082">&nbsp;&nbsp;添加分子式</DIV></TD>
			</TR>
			<TR>
				<TD vAlign="top" >
						...
						<TR>
							...
							<TD bgColor="#ffffff">
								<table border="0" align="left" cellpadding="0" cellspacing="0">
									<TR>
										<TD>
											<font size=2><div id="div_cnfzs" style="width:150px" name="div_cnfzs" contenteditable onfocus="GetObjectName('cnfzs')"></div></font>
											<input type="text" name="cnfzs" id="cnfzs" size="20" maxlength="50" style="display:none"/>
										</TD>
						...
						<TR>
							...
							<TD bgColor="#ffffff">
								<table border="0" align="left" cellpadding="0" cellspacing="0">
									<TR>
										<TD>
											<font size=2><div id="div_fzs" style="width:150px" name="div_fzs" contenteditable onfocus="GetObjectName('fzs')"></div></font>
											<input type="text" name="fzs" id="fzs" size="20" maxlength="50" style="display:none"/>
										</TD>
