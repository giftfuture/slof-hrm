...
//得到要修改个人信息的所属单位名称, 用户组名称，如果是总系统管理员不属于任何单位,
...
%>
            <table height="138" cellSpacing="0" cellPadding="0" width="100%" border="0">
                <TR>
					<TD class="heading" bgColor="#FFDAB9" height="20"><DIV style="font-size:15px;filter:progid:DXImageTransform.Microsoft.Glow(Color=#FFFFFF,Strength=3);width:200px"><font color="#4B0082">&nbsp;&nbsp;修改个人信息</DIV></TD>
                </TR>
                <TR>
                    <TD vAlign="top" >
                        <TABLE style="BORDER-COLLAPSE: collapse" height="101" cellSpacing="1" width="100%" bgColor="#666666" border="0">
                            <TR height="25">
                                <TD bgColor="#FFFAFA" align="center" width="100">用户名</TD>
                                <TD bgColor="#ffffff" ><input name="username" type="text" size="20" maxlength="20" title="最多20个字" id="username" value="<%=username%>" style="border-style:Groove;height:21px;width:120px;"/><FONT face="宋体" color="#ff0000">*&nbsp;&nbsp;注意:用户名和密码不能重复, 不要使用中文</FONT></TD>
                            </TR>
                            <TR height="25">
                                <TD bgColor="#FFFAFA" align="center">密码</TD>
                                <TD bgColor="#ffffff" ><input name="pwd" type="text" size="20" maxlength="20" title="最多20个字" id="pwd" value="<%=pwd%>" style="border-style:Groove;height:21px;width:120px;"/><FONT face="宋体" color="#ff0000">*&nbsp;&nbsp;注意:密码不能少于6位, 不要使用中文</FONT></TD>
                            </TR>
                            <TR height="25">
                                <TD bgColor="#FFFAFA" align="center">重复密码</TD>
                                <TD bgColor="#ffffff" ><input name="repwd" type="password" size="20" maxlength="20" title="最多20个字" id="repwd" value="" style="border-style:Groove;height:21px;width:120px;"/><FONT face="宋体" color="#ff0000">*&nbsp;&nbsp;注意:密码不能少于6位, 不要使用中文</FONT></TD>
                            </TR>
                            <TR>
                            ...
                            <TR height="25">
                                <TD bgColor="#FFFAFA" align="center">用户组</TD>
