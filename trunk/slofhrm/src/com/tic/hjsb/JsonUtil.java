...
public class JsonUtil {
	...
	public static void main(String[] arg) throws Exception {
		 ...
		 * //增加对象中的集合属性的类型以及对象元素中的对象属性的集合属性的类型 Map clazzMap = new HashMap();
		 * //secondItems是FirstDTO里的集合属性 clazzMap.put("secondItems",
		 * SecondDTO.class); //thirdItems是SecondDTO里的集合属性
		 * clazzMap.put("thirdItems", ThirdDTO.class); FirstDTO firstDTO =
		 * (FirstDTO)JsonUtil.getDTO(jsonString, FirstDTO.class, clazzMap);
		 */
	}
}