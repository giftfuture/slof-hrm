...
<%
            ...
            <table height="138" cellSpacing="0" cellPadding="0" width="100%" border="0">
                <TR>
					<TD class="heading" bgColor="#FFDAB9" height="20"><DIV style="font-size:15px;filter:progid:DXImageTransform.Microsoft.Glow(Color=#FFFFFF,Strength=3);width:200px"><font color="#4B0082">&nbsp;&nbsp;修改单位</DIV></TD>
                </TR>
                <TR>
                    <TD vAlign="top" >
                        <TABLE style="BORDER-COLLAPSE: collapse" height="101" cellSpacing="1" width="100%" bgColor="#666666" border="0">
                            <TR>
                                ...
                                <TD bgColor="#ffffff" ><input name="danweiname" type="text" size="50" value="<%=name%>" maxlength="50" id="danweiname"/><FONT face="宋体" color="#ff0000">*</FONT></TD>
                            </TR>
                            <TR>
...
<%}else{%>
    <select name="superiorid_lvl">
        <%
            ...
            //id为上个页面传过来的要修改的单位id，允许登陆用户修改自己所在单位
            //zhu_id登陆用户的单位id
            if (zhu_id.equals(id)){%>
